...
class Assets {
    ...
    public function register_styles() {
        ...
        wp_register_style( 'bootstrap-icons', 'https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.1/font/bootstrap-icons.css', [], '1.11.1', 'all' );
    ...
    public function register_scripts() {
        ...
        wp_register_script( 'bootstrap-js', CUSTOMTHEME_DIR_URI . '/assets/src/library/js/bootstrap.bundle.min.js', [], false, true );
